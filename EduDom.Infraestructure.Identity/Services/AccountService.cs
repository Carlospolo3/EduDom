...
namespace EduDom.Infraestructure.Identity.Services
{
    public class AccountService : IAccountServices
    {
        ...
        public Task<ForgotPasswordResponse> ForgotPasswordRequestAsync(ForgotPasswordRequest request, string origin)
        {
            throw new NotImplementedException();
        }
        ...
        public Task<List<AuthenticationResponse>> GetAllUsersAsync()
        {
            throw new NotImplementedException();
        }

        public Task<AuthenticationResponse> GetUserByIdAsync(string id)
        {
            throw new NotImplementedException();
        }
